...
/**
 * {@link StringListProperty} using ";" as separator and no {@link #isEncloseWithSeparator() enclosing}.<br>
 ...
 * @since 1.0.0
 */
public class StringListCsvProperty extends StringListProperty {
   ...
   */
  public StringListCsvProperty(String name) {
   ...
   */
  public StringListCsvProperty(String name, PropertyMetadata<String> metadata) {
