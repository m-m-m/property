 ...
 * @since 1.0.0
 */
public interface WritableChangeAwareCollectionProperty<V extends Collection<E>, E>
    extends ReadableChangeAwareCollectionProperty<V, E>, WritableCollectionProperty<V, E>,
    WritableChangeAwareCollectionValue<V, E> {
