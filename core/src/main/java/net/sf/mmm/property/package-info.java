 ...
 * This API (and its implementation) comes with {@link net.sf.mmm.property.ReadableProperty} and
 * {@link net.sf.mmm.property.WritableProperty} as well as all the sub-interfaces and implementations to give
 ...
 * {@link net.sf.mmm.property.string.StringListProperty} or
 * {@link net.sf.mmm.property.temporal.DurationInSecondsProperty}.
 *
 * @see net.sf.mmm.util.bean.api.Bean
 * @see net.sf.mmm.property.string.StringProperty
 * @see net.sf.mmm.property.booleans.BooleanProperty
 * @see net.sf.mmm.property.number.integers.IntegerProperty
 * @see net.sf.mmm.property.number.longs.LongProperty
 * @see net.sf.mmm.property.number.bigdecimal.BigDecimalProperty
 * @see net.sf.mmm.property.temporal.instant.InstantProperty
 * @see net.sf.mmm.property.temporal.localdate.LocalDateProperty
 * @see net.sf.mmm.property.temporal.localdatetime.LocalDateTimeProperty
 * @see net.sf.mmm.property.container.list.ListProperty
 * @see net.sf.mmm.property.container.set.SetProperty
 * @see net.sf.mmm.property.container.map.MapProperty
