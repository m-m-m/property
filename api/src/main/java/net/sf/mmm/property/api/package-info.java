 ...
 * {@link net.sf.mmm.property.api.lang.StringListProperty} or
 * {@link net.sf.mmm.property.api.time.DurationInSecondsProperty}.
 *
 * @see net.sf.mmm.util.bean.api.Bean
 * @see net.sf.mmm.property.api.lang.StringProperty
 * @see net.sf.mmm.property.api.lang.BooleanProperty
 * @see net.sf.mmm.property.api.math.IntegerProperty
 * @see net.sf.mmm.property.api.math.LongProperty
 * @see net.sf.mmm.property.api.math.BigDecimalProperty
 * @see net.sf.mmm.property.api.time.InstantProperty
 * @see net.sf.mmm.property.api.time.LocalDateProperty
 * @see net.sf.mmm.property.api.time.LocalDateTimeProperty
 * @see net.sf.mmm.property.api.util.ListProperty
 * @see net.sf.mmm.property.api.util.SetProperty
 * @see net.sf.mmm.property.api.util.MapProperty
 * @see net.sf.mmm.property.api.link.LinkProperty
 * @see net.sf.mmm.property.api.link.LinkListProperty
 */
