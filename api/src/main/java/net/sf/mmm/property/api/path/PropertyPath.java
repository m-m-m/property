...
package net.sf.mmm.property.api.path;
 ...
 * @see net.sf.mmm.property.api.ReadableProperty
 *
...
public interface PropertyPath<V> extends AttributeReadName, AttributeReadValue<V> {
   ...
   *         {@link net.sf.mmm.property.api.ReadableProperty single property} the name of the property. Otherwise
