 ...
 * instantiate implementations such as {@link net.sf.mmm.property.api.lang.StringProperty}. However for generic
...
public interface PropertyFactory<V, P extends ReadableProperty<V>> {
   ...
   *         {@link net.sf.mmm.property.api.lang.GenericProperty}.
   */
   ...
   *        {@link net.sf.mmm.property.api.lang.GenericProperty} or
   *        {@link net.sf.mmm.property.api.util.ListProperty}. Can be {@code null} if the generic value type is
