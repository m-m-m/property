...
package net.sf.mmm.property.base;

import java.util.AbstractList;
import java.util.Collection;

import net.sf.mmm.property.api.containers.lists.ListChangeListener;
import net.sf.mmm.property.api.containers.lists.ObservableList;
