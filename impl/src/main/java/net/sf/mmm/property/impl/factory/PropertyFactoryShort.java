...
import net.sf.mmm.property.api.math.ReadableShortProperty;
import net.sf.mmm.property.api.math.ShortProperty;
import net.sf.mmm.property.api.math.WritableShortProperty;
